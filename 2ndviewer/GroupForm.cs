...
namespace _2ndviewer
{
    ...
    public partial class GroupForm : WeifenLuo.WinFormsUI.Docking.DockContent
    {
        ...
        /// <summary>グループリストボックスを再構築します</summary>
        ...
        /// <summary>リストボックスの選択が変更された時に呼ばれるメソッドです</summary>
        ...
        /// <summary>グループを作成します</summary>
        private void create_button_Click(object sender, EventArgs e)
        {
            // IMPLEMENT ME
        }

        /// <summary>グループをアクティブにします</summary>
        ...
        /// <summary>グループ情報表示ウィンドウを表示します</summary>
